...
jayutil_unit_generate_impl!(AngleUnit);
...
pub const ARCMINUTES: AngleUnit = AngleUnit::from(std::f64::consts::PI / 10800.0, "Arcminutes", "′");
pub const ARCSECONDS: AngleUnit = AngleUnit::from(std::f64::consts::PI / 648_000.0, "Arcseconds", "″");
pub const REVOLUTIONS: AngleUnit = AngleUnit::from(2.0 * std::f64::consts::PI, "Revolutions", "rev");
